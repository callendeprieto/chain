...
;   - 29/04/2012: optimized (using several 1d convolutions instead of multidimensional one)
;
;-
; LICENCE:
...
;-
;
function cSMOOTH, input_array, width, $
...
for i=0,N_ELEMENTS(real_width)-1 do begin
	...
	output_array=CONVOL(temporary(output_array), gate, norm_of_gate, EDGE_TRUNCATE=EDGE_TRUNCATE)
	;
